...
const nextConfig: NextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      { protocol: "https", hostname: "*.supabase.co", pathname: "/storage/v1/object/public/team-favicons/**" },
      ...
      { protocol: "http", hostname: "127.0.0.1", port: "54321", pathname: "/storage/v1/object/public/team-favicons/**" },
      ...
      { protocol: "http", hostname: "localhost", port: "54321", pathname: "/storage/v1/object/public/team-favicons/**" },
