...
"[project]/apps/web/app/api/feed/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    `).in("user_id", followingIds).order("created_at", {
        ascending: false
    }).limit(limit);
    if (cursor) {
    ...
    const { data: userKudos } = postIds.length ? await supabase.from("kudos").select("post_id").eq("user_id", user.id).in("post_id", postIds) : {
        data: []
    };
    ...
    const next_cursor = enriched.length === limit ? enriched[enriched.length - 1]?.created_at : undefined;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$bun$2f$next$40$16$2e$1$2e$6$2b$67f6792bdf102c28$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        posts: enriched,
        next_cursor
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c00ab8e._.js.map