export function FeaturesGrid() {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-12 border-t border-[#222]">
      {/* Section title block */}
      <div className="lg:col-span-4 border-b border-r-0 lg:border-r border-[#222] p-8 lg:p-16 flex flex-col justify-between gap-12 bg-[#050505]">
        <h2 className="text-accent font-medium text-[clamp(2rem,5vw,4rem)] leading-none tracking-[-0.03em]">
          01
        </h2>
        <div>
          <h3 className="text-[#F0F0F0] text-xl font-medium tracking-[-0.03em] leading-tight mb-2">
            Telemetry for
            <br />
            Claude Code.
          </h3>
          <p className="font-[family-name:var(--font-mono)] text-sm uppercase tracking-wider text-[#888]">
            Core Capabilities
          </p>
        </div>
      </div>
      ...
      {/* Feature cards 2x2 */}
      <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 border-b border-[#222]">
        <FeatureCard
          icon="[$]"
          title="Track Spend"
          description="Real-time token counting and cost attribution per session."
          className="border-b sm:border-r border-[#222]"
        />
        <FeatureCard
          icon="[~]"
          title="Compare Pace"
        ...
        <FeatureCard
          ...
          className="border-b sm:border-b-0 sm:border-r border-[#222]"
        />
        <FeatureCard
          icon="[>]"
...
function FeatureCard({
  ...
  return (
    ...
    >
      ...
      <h4 className="text-[#F0F0F0] font-medium text-base">{title}</h4>
      <p className="font-[family-name:var(--font-mono)] text-sm text-[#888] leading-relaxed">
        {description}
      </p>
    </div>
  );
