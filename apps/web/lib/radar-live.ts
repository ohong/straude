...
async function getDistributions(): Promise<CachedDistributions> {
  ...
  const [{ data: allUsage }, { data: allUsers }, { data: allFollows }, { data: allPosts }, { data: allKudos }] = results;
 ...
 */
export async function computeLiveRadarScores(userId: string): Promise<RadarScores> {
